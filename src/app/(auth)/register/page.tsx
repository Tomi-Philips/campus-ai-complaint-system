...
import { Zap, GitBranch, ArrowRight, Sparkles, Shield, CheckCircle, Eye, EyeOff } from 'lucide-react';
    ...
    <div className="flex-1 flex items-center justify-center p-4 md:p-6 relative overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full max-w-6xl">
          <div className="absolute top-1/4 -right-20 w-80 h-80 bg-gradient-to-r from-brand-500/20 to-brand-600/10 rounded-full blur-[120px] animate-pulse" />
          <div className="absolute bottom-1/4 -left-20 w-80 h-80 bg-gradient-to-r from-accent-500/20 to-accent-600/10 rounded-full blur-[120px] animate-pulse [animation-delay:1s]" />
      ...
      >
        ...
        <div className="text-center mb-8 md:mb-10">
          ...
          >
            <h1 className="text-3xl md:text-4xl font-black tracking-tight mb-2 md:mb-3 font-display">
              <span className="bg-gradient-to-r from-white to-slate-300 bg-clip-text text-transparent">Create </span>
              <span className="bg-gradient-to-r from-brand-400 via-brand-300 to-accent-400 bg-clip-text text-transparent">Account</span>
            </h1>
          </motion.div>
        ...
        >
          ...
          <div className="relative bg-slate-900/90 backdrop-blur-xl p-6 md:p-8 rounded-3xl border border-slate-700/50 shadow-2xl overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
              ...
              <Button 
                type="submit" 
                className="w-full h-11 md:h-12 text-base md:text-lg font-bold bg-gradient-to-r from-brand-500 to-brand-600 hover:from-brand-600 hover:to-brand-700 shadow-lg shadow-brand-500/25 hover:shadow-xl hover:shadow-brand-500/40 transition-all duration-200 mt-4 rounded-xl" 
                isLoading={isLoading}
              >
              ...
              <div className="flex items-center justify-center gap-6 mt-6 pt-2">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[11px] text-slate-500 font-medium">Free forever</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <CheckCircle className="w-3 h-3 text-emerald-500" />
                  <span className="text-[11px] text-slate-500 font-medium">No credit card</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <CheckCircle className="w-3 h-3 text-emerald-500" />
                  <span className="text-[11px] text-slate-500 font-medium">Cancel anytime</span>
                </div>
              </div>
            </form>
          </div>
        ...
        >
          ...
          <Link href="/login" className="text-brand-400 font-bold hover:text-brand-300 transition-colors relative inline-block group">
            Sign In
